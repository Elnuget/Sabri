	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					<a href="#!" class="btn-sideBar-SubMenu">
						<i class="zmdi zmdi-card zmdi-hc-fw"></i> Payments <i Dialogclass="zmdi zmdi-caret-down pull-right"></i>
					</a>
					<ul class="list-unstyled full-box">
						<li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Usuarios <small>Admin</small></h1>
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	<li class="active"><a href="#new" data-toggle="tab">Nuevo Usuario</a></li>
								...
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form action="admin.php" method="post">
										    ...
										    <p class="text-center">
										    	<button href="#!" class="btn btn-secondary btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Guardar</button>
										    </p>
									    </form>
									</div>
								</div>
								...
								<table class="table table-hover text-center">
									...
									<?php foreach($resultado as $proyecto){ ?>
										<tr >
											...
											<td><a class="btn btn-danger btn-raised btn-xs" href="?borrar=<?php echo $proyecto['id']; ?>" ><i class="zmdi zmdi-delete"></i></a></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
